...
public class CarrosController {
	...
	public ModelAndView listar() {
		...
		modelAndView.addObject("carros", carroService.buscarCarros());
		modelAndView.addObject("carrosBD", carroService.buscarCarrosNoBanco());
	...
	public ModelAndView editar(@PathVariable("id") Long id) {
		...
		modelAndView.addObject("carro", carroService.buscarPeloId(id));
		return modelAndView;
	}
